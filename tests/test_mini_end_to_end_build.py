...
def test_mini_end_to_end_build_over_hundred_article_fixture(tmp_path: Path) -> None:
    # ADR-015's 100-article gate: register -> ingest -> normalize -> generate ->
    # verify must all complete cleanly before any larger-scale build is allowed.
